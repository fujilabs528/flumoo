...
print("EARNINGS PER SHARE MARKET REPORT - OCTOBER 20/2020")
###########################################################
...
sexlistDF = pd.DataFrame()
sexlistDF["peRatio"] = sexlist

overlistDF = pd.DataFrame()
overlistDF["ticker name "] = overlist

mariners = (overlistDF.join(sexlistDF))

mariners['peRatio'] = pd.to_numeric(mariners['peRatio'],errors="coerce")

print(mariners)

falcons= mariners.sort_values(by= "peRatio")
...
print("STATISTICS")
print("MAX", charlie["peRatio"])
print("MIN", delta["peRatio"])
print("MEAN", echo["peRatio"])
print("MEDIAN",foxtrot["peRatio"])
print("STAN DEV",golf["peRatio"])
print("VAR", hotel["peRatio"])
print("SKEW",india["peRatio"])
print("KURTOSIS",juliet["peRatio"])

# RANGE INFO
kilo= charlie["peRatio"]
kilo= float(kilo)
lima=delta["peRatio"]
lima=float(lima)
mike= (kilo-lima)
