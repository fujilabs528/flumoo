...
alpha = pd.read_sql_table("revenue", engine)
tickerlist=[]
for x in alpha["tickername"]:
    tickerlist.append(x)
ohlist= []
for j in alpha["revenue"]:
    ohlist.append(j)
sexlist=[]
for r in p:
...
#print(sexlist)
##########################################################
alpha = pd.read_sql_table("net income", engine)
tickerlist1=[]
for x in alpha["tickername"]:
    tickerlist1.append(x)
ohlist1= []
for j in alpha["net income"]:
    ohlist1.append(j)
sexlist1=[]
for r in p:
...
shiplistDF["top2bottomratio"]= shiplist
pDF=pd.DataFrame()
pDF["tickername"]=p
mariners= pDF.join(shiplistDF)
#print(mariners)
falcons = mariners.sort_values(by="top2bottomratio")
print(falcons)
##########################################################
brotherlist=[]
...
sisterlist=[]
for k in falcons["top2bottomratio"]:
    sisterlist.append(k)
sisterlistDF=pd.DataFrame()
sisterlistDF["top2bottomratio"]=sisterlist
unclelist=[]
for bb in range(505):
    unclelist.append(bb)
...
patriots.to_sql("top2bottomratio",engine)