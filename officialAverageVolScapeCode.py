...
print("AVERAGE VOL MARKET REPORT - OCTOBER 16/2020")
###########################################################
...
extralistDF["averageVolume"]= extralist
...
mariners['averageVolume'] = pd.to_numeric(mariners['averageVolume'],errors="coerce")


falcons= mariners.sort_values(by= "averageVolume")
...
print("STATISTICS")
print("MAX", charlie["averageVolume"])
print("MIN", delta["averageVolume"])
print("MEAN", echo["averageVolume"])
print("MEDIAN",foxtrot["averageVolume"])
print("STAN DEV",golf["averageVolume"])
print("VAR", hotel["averageVolume"])
print("SKEW",india["averageVolume"])
print("KURTOSIS",juliet["averageVolume"])

# RANGE INFO
kilo= charlie["averageVolume"]
kilo= float(kilo)
lima=delta["averageVolume"]
lima=float(lima)
mike= (kilo-lima)
print("RANGE", mike)
november= mike/30
...
for l in falcons["averageVolume"]:
    if l < index[1]:
        list_1.append(l)
